...
- For the database file select the Database1.mdf file located in the database folder
- Click on OK to add the database
- Now ensure in the SQL Server Object Explorer that the database is named 'Session1'. If this is not the case you should change the name.
